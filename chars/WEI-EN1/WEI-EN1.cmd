; キャラクター『ウェイ(エヌアイン完全世界仕様)』のコマンドファイルです。
...
[State -1, 2-8Y+Z]
type = ChangeState
triggerall = (command = "y+z") || (command = "a")
...
[State -1, 2-8Y+Z]
type = ChangeState
triggerall = (command = "2-8SP")
triggerall = (StateType != A)
triggerall = power >= 1000
triggerall =  Var(11) != 0
triggerall = Stateno != 2300
trigger1 = Ctrl || stateno = 12 || stateno = 40
value = 2300
...
triggerall = (StateType != A)
triggerall = Var(17) != 0
trigger1 = Stateno = 210 || Stateno = 410 || Stateno = 201
value = 211
